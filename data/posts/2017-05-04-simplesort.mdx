...
<Image src={'/static/images/blogs/sort.png'} alt="sort" width={683} height={260} />
...
<Image src={'/static/images/blogs/sort2.png'} alt="sort2" width={567} height={332} />
...
<Image src={'/static/images/blogs/sort3.png'} alt="sort3" width={580} height={311} />
...
<Image src={'/static/images/blogs/sort4.png'} alt="sort" width={574} height={354} />

最后来一个可视化的运行轨迹。

<Image src={'/static/images/blogs/sort5.png'} alt="sort" width={401} height={566} />
...
<Image src={'/static/images/blogs/sort6.png'} alt="sort" width={337} height={291} />

排序的图示：

<Image src={'/static/images/blogs/sort7.png'} alt="sort" width={368} height={580} />

可视化图示：

<Image src={'/static/images/blogs/sort8.png'} alt="sort" width={527} height={438} />
